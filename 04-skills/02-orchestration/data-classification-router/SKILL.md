...
description: Routes information and tasks only to models, tools, repositories, locations, and users permitted by the applicable data classification. Use before any AI processing, connector call, cross-entity sharing, or external model use.
...
## Objective
Routes information and tasks only to models, tools, repositories, locations, and users permitted by the applicable data classification. Use before any AI processing, connector call, cross-entity sharing, or external model use.
...
## Human approval
Data owner and security. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
