---
name: source-hierarchy-resolver
description: Ranks conflicting sources by legal authority, ownership, recency, audit status, independence, and relevance; records unresolved discrepancies. Use when data, policies, valuations, or narratives disagree.
...
## Objective
Ranks conflicting sources by legal authority, ownership, recency, audit status, independence, and relevance; records unresolved discrepancies.

## Use when
data, policies, valuations, or narratives disagree.
...
## Human approval
Subject-matter owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
