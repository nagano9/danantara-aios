---
name: escalation-and-exception-router
description: Escalates unresolved conflicts, missing authority, inadequate evidence, policy exceptions, critical risks, ethical concerns, or prohibited actions to the correct human body. Use whenever standard workflow cannot safely continue.
...
## Objective
Escalates unresolved conflicts, missing authority, inadequate evidence, policy exceptions, critical risks, ethical concerns, or prohibited actions to the correct human body.

## Use when
ever standard workflow cannot safely continue.
...
## Human approval
Designated escalation authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
