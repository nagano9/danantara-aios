---
name: benchmark-intelligence-manager
description: Selects relevant global, regional, sector, sovereign-fund, and peer-company benchmarks; normalizes definitions and explains comparability limits. Use for performance targets, valuation, operating models, governance, and transformation ambition.
...
## Objective
Selects relevant global, regional, sector, sovereign-fund, and peer-company benchmarks; normalizes definitions and explains comparability limits. Use for performance targets, valuation, operating models, governance, and transformation ambition.
...
## Human approval
Analysis owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
