---
name: decision-precedent-retriever
description: Retrieves comparable prior decisions, their rationale, assumptions, approvals, outcomes, and lessons without treating precedent as automatic authority. Use for board, investment, restructuring, policy, and exception decisions.
...
## Objective
Retrieves comparable prior decisions, their rationale, assumptions, approvals, outcomes, and lessons without treating precedent as automatic authority. Use for board, investment, restructuring, policy, and exception decisions.
...
## Human approval
Decision owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
