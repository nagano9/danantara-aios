---
name: policy-knowledge-curator
description: Curates approved policies, manuals, delegations, standards, templates, effective dates, superseded versions, and owners into a controlled knowledge base. Use when building or updating authoritative Danantara policy context.
...
# Policy Knowledge Curator

## Objective
Curates approved policies, manuals, delegations, standards, templates, effective dates, superseded versions, and owners into a controlled knowledge base.

## Use when
building or updating authoritative Danantara policy context.
...
## Human approval
Policy owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
