...
description: Monitors applicable laws, regulations, decisions, standards, and official guidance; maps changes to affected entities, processes, documents, and controls. Use for regulatory horizon scanning and change-impact assessment.
...
## Objective
Monitors applicable laws, regulations, decisions, standards, and official guidance; maps changes to affected entities, processes, documents, and controls. Use for regulatory horizon scanning and change-impact assessment.
...
## Human approval
Legal owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
