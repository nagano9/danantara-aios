---
name: data-quality-and-lineage-checker
description: Tests completeness, accuracy, consistency, timeliness, ownership, reconciliation, transformations, and source lineage of decision data. Use before models, dashboards, consolidated reporting, valuations, and material recommendations.
...
## Objective
Tests completeness, accuracy, consistency, timeliness, ownership, reconciliation, transformations, and source lineage of decision data. Use before models, dashboards, consolidated reporting, valuations, and material recommendations.
...
## Human approval
Data owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
