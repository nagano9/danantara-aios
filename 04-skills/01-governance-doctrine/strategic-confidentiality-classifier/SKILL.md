---
name: strategic-confidentiality-classifier
description: Classifies information by sensitivity, strategic importance, legal restriction, market impact, personal data, and national-security relevance. Use before retrieval, sharing, model processing, cross-border transfer, publication, or external collaboration.
...
## Objective
Classifies information by sensitivity, strategic importance, legal restriction, market impact, personal data, and national-security relevance. Use before retrieval, sharing, model processing, cross-border transfer, publication, or external collaboration.
...
## Human approval
Information owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
