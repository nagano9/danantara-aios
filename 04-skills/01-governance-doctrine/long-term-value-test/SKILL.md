---
name: long-term-value-test
description: Assesses whether a decision creates durable economic, strategic, capability, resilience, and intergenerational value over 10–20 years. Use when short-term earnings, political urgency, or temporary market conditions could distort the decision.
...
# Long Term Value Test

## Objective
Assesses whether a decision creates durable economic, strategic, capability, resilience, and intergenerational value over 10–20 years.

## Use when
short-term earnings, political urgency, or temporary market conditions could distort the decision.
...
## Human approval
Strategy and investment owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
