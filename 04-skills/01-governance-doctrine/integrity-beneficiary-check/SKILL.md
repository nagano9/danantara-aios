---
name: integrity-beneficiary-check
description: Tests whether a proposal is lawful, ethical, independently supportable, and free from concealed beneficiaries, side arrangements, or improper advantage. Use when a transaction or instruction appears formally compliant but substantively questionable.
...
# Integrity Beneficiary Check

## Objective
Tests whether a proposal is lawful, ethical, independently supportable, and free from concealed beneficiaries, side arrangements, or improper advantage.

## Use when
a transaction or instruction appears formally compliant but substantively questionable.
...
## Human approval
Ethics/compliance owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
