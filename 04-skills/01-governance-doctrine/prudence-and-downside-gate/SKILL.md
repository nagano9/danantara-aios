---
name: prudence-and-downside-gate
description: Tests capital preservation, permanent-loss risk, downside scenarios, reversibility, liquidity, and risk ownership. Use before committing capital, extending support, changing strategy, accepting guarantees, or approving high-uncertainty initiatives.
...
## Objective
Tests capital preservation, permanent-loss risk, downside scenarios, reversibility, liquidity, and risk ownership. Use before committing capital, extending support, changing strategy, accepting guarantees, or approving high-uncertainty initiatives.
...
## Human approval
Risk owner and approving authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
