---
name: mandate-authority-interpreter
description: Interprets the applicable mandate, legal authority, delegated power, and institutional boundary for a proposed action. Use when responsibility among BPI, DAM, DIM, DDMF, BUMN, boards, committees, or government stakeholders is unclear.
...
## Objective
Interprets the applicable mandate, legal authority, delegated power, and institutional boundary for a proposed action.

## Use when
responsibility among BPI, DAM, DIM, DDMF, BUMN, boards, committees, or government stakeholders is unclear.
...
## Human approval
Legal/governance owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
