---
name: transparency-disclosure-gate
description: Determines what material information, assumptions, risks, decisions, and performance must be documented or disclosed while preserving lawful confidentiality. Use for board papers, investor materials, public statements, financial reporting, and major decisions.
...
## Objective
Determines what material information, assumptions, risks, decisions, and performance must be documented or disclosed while preserving lawful confidentiality. Use for board papers, investor materials, public statements, financial reporting, and major decisions.
...
## Human approval
Disclosure/legal owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
