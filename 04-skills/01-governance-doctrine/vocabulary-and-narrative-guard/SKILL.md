---
name: vocabulary-and-narrative-guard
description: Enforces Danantara preferred vocabulary and flags unsupported phrases, vague synergies, informal-instruction logic, unmeasured national impact, bailout framing, and narrative-only decisions. Use when drafting or reviewing any formal Danantara output.
...
## Objective
Enforces Danantara preferred vocabulary and flags unsupported phrases, vague synergies, informal-instruction logic, unmeasured national impact, bailout framing, and narrative-only decisions.

## Use when
drafting or reviewing any formal Danantara output.
...
## Human approval
Document owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
