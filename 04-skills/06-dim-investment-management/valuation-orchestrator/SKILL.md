...
description: Selects and reconciles DCF, comparables, transactions, asset value, project finance, option value, and scenario methods; documents assumptions and valuation range. Use when estimating intrinsic value or negotiating price.
...
## Objective
Selects and reconciles DCF, comparables, transactions, asset value, project finance, option value, and scenario methods; documents assumptions and valuation range.

## Use when
estimating intrinsic value or negotiating price.
...
## Human approval
Investment or transaction authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
