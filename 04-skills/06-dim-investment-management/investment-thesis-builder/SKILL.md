...
description: Builds a falsifiable investment thesis covering value drivers, variant perception, competitive advantage, catalysts, downside, national consequence, entry valuation, ownership plan, and exit logic. Use for shortlisted opportunities.
...
## Objective
Builds a falsifiable investment thesis covering value drivers, variant perception, competitive advantage, catalysts, downside, national consequence, entry valuation, ownership plan, and exit logic. Use for shortlisted opportunities.
...
## Human approval
Investment team and committee. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
