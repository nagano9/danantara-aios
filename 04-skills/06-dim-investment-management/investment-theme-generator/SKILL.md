---
name: investment-theme-generator
description: Develops evidence-based investment themes from national priorities, structural trends, market gaps, capabilities, resilience needs, and risk-adjusted opportunity. Use for strategy refresh, origination, and sector allocation.
...
# Investment Theme Generator

## Objective
Develops evidence-based investment themes from national priorities, structural trends, market gaps, capabilities, resilience needs, and risk-adjusted opportunity. Use for strategy refresh, origination, and sector allocation.
...
## Human approval
DIM strategy authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
