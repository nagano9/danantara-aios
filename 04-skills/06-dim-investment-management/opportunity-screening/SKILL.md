...
description: Screens opportunities for mandate fit, strategic relevance, commercial logic, readiness, sponsor quality, preliminary risk-return, additionality, impact, and fatal flaws. Use before allocating due-diligence resources.
...
## Objective
Screens opportunities for mandate fit, strategic relevance, commercial logic, readiness, sponsor quality, preliminary risk-return, additionality, impact, and fatal flaws. Use before allocating due-diligence resources.
...
## Human approval
DIM screening authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
