...
## Objective
Translates DIM's mandate into eligible assets, return objectives, risk appetite, impact expectations, geography, liquidity, horizon, concentration, exclusions, and approval requirements. Use before screening or designing an investment strategy.
...
## Human approval
DIM mandate authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
