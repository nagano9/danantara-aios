...
description: Defines, assigns, evidences, and tracks legal, financial, technical, regulatory, governance, ESG, funding, and operational conditions before signing, closing, disbursement, or subsequent drawdown. Use after conditional approval.
...
## Objective
Defines, assigns, evidences, and tracks legal, financial, technical, regulatory, governance, ESG, funding, and operational conditions before signing, closing, disbursement, or subsequent drawdown. Use after conditional approval.
...
## Human approval
Transaction owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
