---
name: post-investment-monitor
description: Monitors thesis, value-creation plan, financial and operational KPIs, covenants, risk, impact, governance, liquidity, valuation, and intervention triggers. Use throughout the ownership period.
...
## Objective
Monitors thesis, value-creation plan, financial and operational KPIs, covenants, risk, impact, governance, liquidity, valuation, and intervention triggers. Use throughout the ownership period.
...
## Human approval
Portfolio management authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
