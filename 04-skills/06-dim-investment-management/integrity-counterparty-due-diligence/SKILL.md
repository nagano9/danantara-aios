---
name: integrity-counterparty-due-diligence
description: Assesses beneficial ownership, reputation, sanctions, politically exposed persons, corruption risk, litigation, governance, financial credibility, and conduct history. Use for sponsors, sellers, partners, co-investors, advisers, and key contractors.
...
## Objective
Assesses beneficial ownership, reputation, sanctions, politically exposed persons, corruption risk, litigation, governance, financial credibility, and conduct history. Use for sponsors, sellers, partners, co-investors, advisers, and key contractors.
...
## Human approval
Compliance and investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
