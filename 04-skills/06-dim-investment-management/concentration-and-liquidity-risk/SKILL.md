---
name: concentration-and-liquidity-risk
description: Quantifies single-name, sector, correlated, currency, funding, exit, and cash-call risks under normal and stressed conditions. Use for portfolio construction, commitment pacing, and risk-limit decisions.
...
## Objective
Quantifies single-name, sector, correlated, currency, funding, exit, and cash-call risks under normal and stressed conditions. Use for portfolio construction, commitment pacing, and risk-limit decisions.
...
## Human approval
Portfolio risk authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
