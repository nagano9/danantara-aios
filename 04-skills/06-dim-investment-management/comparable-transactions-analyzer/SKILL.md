---
name: comparable-transactions-analyzer
description: Selects, normalizes, and interprets comparable companies and precedent transactions, including business-model, growth, risk, geography, control, cycle, and accounting differences. Use to triangulate valuation and market expectations.
...
# Comparable Transactions Analyzer

## Objective
Selects, normalizes, and interprets comparable companies and precedent transactions, including business-model, growth, risk, geography, control, cycle, and accounting differences. Use to triangulate valuation and market expectations.
...
## Human approval
Valuation owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
