...
description: Evaluates strategic sale, IPO, secondary, refinancing, dividend recapitalization, asset sale, wind-down, or continued ownership using value, timing, readiness, impact, and market scenarios. Use from entry planning through exit decision.
...
## Objective
Evaluates strategic sale, IPO, secondary, refinancing, dividend recapitalization, asset sale, wind-down, or continued ownership using value, timing, readiness, impact, and market scenarios. Use from entry planning through exit decision.
...
## Human approval
Authorized exit authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
