---
name: technical-operational-due-diligence
description: Tests technology, design, capacity, reliability, resources, operations, supply chain, capex, schedule, standards, and execution readiness. Use for infrastructure, industrial, energy, digital, and technology investments.
...
## Objective
Tests technology, design, capacity, reliability, resources, operations, supply chain, capex, schedule, standards, and execution readiness. Use for infrastructure, industrial, energy, digital, and technology investments.
...
## Human approval
Technical and investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
