---
name: legal-tax-due-diligence
description: Reviews ownership, authority, licenses, contracts, litigation, compliance, land, tax, sanctions, change-of-control, and transaction enforceability. Use before commitments, signing, closing, or material restructuring.
...
## Objective
Reviews ownership, authority, licenses, contracts, litigation, compliance, land, tax, sanctions, change-of-control, and transaction enforceability. Use before commitments, signing, closing, or material restructuring.
...
## Human approval
Legal/tax and investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
