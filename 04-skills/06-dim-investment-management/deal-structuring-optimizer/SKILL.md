---
name: deal-structuring-optimizer
description: Designs equity, debt, hybrid, governance, downside protection, control, covenant, distribution, tax, currency, and exit terms aligned with risk allocation and objectives. Use after diligence and before term-sheet approval.
...
## Objective
Designs equity, debt, hybrid, governance, downside protection, control, covenant, distribution, tax, currency, and exit terms aligned with risk allocation and objectives. Use after diligence and before term-sheet approval.
...
## Human approval
Investment committee and legal. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
