---
name: project-delivery-monitor
description: Monitors scope, schedule, cost, quality, permits, land, procurement, financing, contractors, safeguards, benefits, and critical-path risks. Use from development through commissioning and stabilization.
...
## Objective
Monitors scope, schedule, cost, quality, permits, land, procurement, financing, contractors, safeguards, benefits, and critical-path risks. Use from development through commissioning and stabilization.
...
## Human approval
Project sponsor. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
