---
name: development-impact-assessor
description: Defines and measures economic, social, resilience, employment, domestic-value, capability, sovereignty, regional, and environmental outcomes with attribution and baselines. Use for development investments and public-infrastructure decisions.
...
## Objective
Defines and measures economic, social, resilience, employment, domestic-value, capability, sovereignty, regional, and environmental outcomes with attribution and baselines. Use for development investments and public-infrastructure decisions.
...
## Human approval
DDMF investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
