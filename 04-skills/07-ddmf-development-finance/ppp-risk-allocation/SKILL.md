---
name: ppp-risk-allocation
description: Allocates construction, demand, tariff, land, regulatory, political, force-majeure, operating, financing, and residual-value risks to parties best able to manage them. Use for public-private partnership design and review.
...
## Objective
Allocates construction, demand, tariff, land, regulatory, political, force-majeure, operating, financing, and residual-value risks to parties best able to manage them. Use for public-private partnership design and review.
...
## Human approval
PPP contracting authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
