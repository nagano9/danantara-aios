---
name: bankability-gap-analyzer
description: Identifies why a project cannot yet attract finance, including weak cash flow, demand, contracts, risk allocation, sponsor, permits, tariffs, guarantees, or execution capacity. Use to define project-preparation interventions.
...
## Objective
Identifies why a project cannot yet attract finance, including weak cash flow, demand, contracts, risk allocation, sponsor, permits, tariffs, guarantees, or execution capacity. Use to define project-preparation interventions.
...
## Human approval
DDMF project/investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
