---
name: additionality-assessor
description: Tests whether Danantara participation creates outcomes, scale, speed, quality, risk reduction, capability, or capital mobilization that the market would not deliver alone. Use before catalytic or concessional intervention.
...
## Objective
Tests whether Danantara participation creates outcomes, scale, speed, quality, risk reduction, capability, or capital mobilization that the market would not deliver alone. Use before catalytic or concessional intervention.
...
## Human approval
Investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
