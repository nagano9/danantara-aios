---
name: viability-gap-support-assessor
description: Tests whether viability-gap support is necessary, proportionate, transparent, time-bound, competitively allocated, and linked to measurable public outcomes. Use when commercially weak but socially valuable projects seek support.
...
## Objective
Tests whether viability-gap support is necessary, proportionate, transparent, time-bound, competitively allocated, and linked to measurable public outcomes.

## Use when
commercially weak but socially valuable projects seek support.
...
## Human approval
Public funding authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
