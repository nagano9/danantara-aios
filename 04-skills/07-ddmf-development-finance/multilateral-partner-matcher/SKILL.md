---
name: multilateral-partner-matcher
description: Matches projects with suitable multilateral, bilateral, development-finance, export-credit, philanthropic, and institutional partners based on instruments, mandate, geography, sector, standards, and knowledge contribution.
...
# Multilateral Partner Matcher

## Objective
Matches projects with suitable multilateral, bilateral, development-finance, export-credit, philanthropic, and institutional partners based on instruments, mandate, geography, sector, standards, and knowledge contribution.
...
## Human approval
Partnership authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
