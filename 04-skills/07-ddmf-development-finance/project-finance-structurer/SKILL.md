---
name: project-finance-structurer
description: Structures project cash flows, contracts, debt capacity, coverage ratios, reserves, security, covenants, risk allocation, and financing plan. Use for infrastructure and ring-fenced project investments.
...
## Objective
Structures project cash flows, contracts, debt capacity, coverage ratios, reserves, security, covenants, risk allocation, and financing plan. Use for infrastructure and ring-fenced project investments.
...
## Human approval
Investment, finance, and legal authorities. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
