---
name: socioeconomic-multiplier-modeler
description: Models direct, indirect, induced, regional, employment, productivity, tax, import, domestic-value, and distributional effects with transparent assumptions. Use to compare development pathways and validate claimed national impact.
...
## Objective
Models direct, indirect, induced, regional, employment, productivity, tax, import, domestic-value, and distributional effects with transparent assumptions. Use to compare development pathways and validate claimed national impact.
...
## Human approval
Impact and economic authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
