---
name: development-outcome-monitor
description: Tracks whether funded projects deliver agreed return, service, resilience, employment, capability, inclusion, environmental, and capital-mobilization outcomes. Use after financial close and throughout operations.
...
## Objective
Tracks whether funded projects deliver agreed return, service, resilience, employment, capability, inclusion, environmental, and capital-mobilization outcomes. Use after financial close and throughout operations.
...
## Human approval
DDMF impact owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
