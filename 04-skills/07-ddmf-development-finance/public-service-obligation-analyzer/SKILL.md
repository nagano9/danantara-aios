---
name: public-service-obligation-analyzer
description: Separates commercial activities from public-service obligations, quantifies costs and outcomes, defines compensation mechanisms, and prevents cross-subsidy opacity. Use for infrastructure and essential-service projects.
...
metadata:
  owner: DDMF/BPI
  cluster: 07-ddmf-development-finance
  risk-tier: critical
  version: "1.0.0"
  status: draft
...
# Public Service Obligation Analyzer

## Objective
Separates commercial activities from public-service obligations, quantifies costs and outcomes, defines compensation mechanisms, and prevents cross-subsidy opacity. Use for infrastructure and essential-service projects.
...
## Required inputs
Project concept; public outcomes; feasibility and safeguards; contracts; demand; funding plan; sponsor capacity; institutional framework.
...
## Workflow
1. Define the development problem, public outcome, project stage, sponsor, and institutional responsibilities.
2. Assess project readiness, demand, technical feasibility, safeguards, legal basis, delivery capacity, and commercial cash flow.
3. Identify bankability gaps, additionality, risk allocation, funding instruments, and minimum catalytic intervention.
4. Quantify return, public-service value, socioeconomic impact, capital mobilization, fiscal exposure, and downside.
5. Run independent challenge on subsidy, moral hazard, procurement, execution, and measurable outcomes.
6. Produce a stage-gated financing and delivery plan with conditions, owners, monitoring, and exit or handover criteria.
...
## Output contract
Primary output: Readiness and bankability assessment; development impact; financing and risk allocation; catalytic intervention; stage gates; delivery monitoring.
...
## Human approval
Mandated public authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
