---
name: executive-board-brief-builder
description: Builds concise decision briefs with issue, recommendation, alternatives, evidence, scenarios, risks, dissent, decision rights, approvals, and action tracking. Use for executive, supervisory, board, or committee meetings.
...
## Objective
Builds concise decision briefs with issue, recommendation, alternatives, evidence, scenarios, risks, dissent, decision rights, approvals, and action tracking. Use for executive, supervisory, board, or committee meetings.
...
## Human approval
Meeting owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
