---
name: transformation-agenda-orchestrator
description: Coordinates enterprise-wide transformation themes, target architecture, waves, accountable owners, dependencies, benefits, and intervention thresholds. Use for multi-BUMN or cross-holding transformation programs.
...
# Transformation Agenda Orchestrator

## Objective
Coordinates enterprise-wide transformation themes, target architecture, waves, accountable owners, dependencies, benefits, and intervention thresholds. Use for multi-BUMN or cross-holding transformation programs.
...
## Human approval
Transformation sponsor. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
