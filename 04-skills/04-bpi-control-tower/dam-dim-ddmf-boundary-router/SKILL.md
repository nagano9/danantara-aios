---
name: dam-dim-ddmf-boundary-router
description: Determines whether an opportunity belongs primarily to active BUMN ownership, commercial investment, development finance, or coordinated treatment. Use when mandate overlap or funding-vehicle ambiguity exists.
...
# Dam Dim Ddmf Boundary Router

## Objective
Determines whether an opportunity belongs primarily to active BUMN ownership, commercial investment, development finance, or coordinated treatment.

## Use when
mandate overlap or funding-vehicle ambiguity exists.
...
## Human approval
BPI authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
