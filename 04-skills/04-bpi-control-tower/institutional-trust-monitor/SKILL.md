---
name: institutional-trust-monitor
description: Evaluates how decisions, disclosures, governance, execution, and exceptions affect credibility, cost of capital, partner confidence, employee confidence, and public legitimacy. Use for sensitive or precedent-setting actions.
...
## Objective
Evaluates how decisions, disclosures, governance, execution, and exceptions affect credibility, cost of capital, partner confidence, employee confidence, and public legitimacy. Use for sensitive or precedent-setting actions.
...
## Human approval
Executive/governance owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
