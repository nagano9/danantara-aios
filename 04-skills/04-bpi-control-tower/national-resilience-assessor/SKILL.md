---
name: national-resilience-assessor
description: Assesses exposure and response options for disruptions affecting energy, food, health, finance, digital systems, critical minerals, infrastructure, and strategic supply chains. Use for resilience investments and contingency decisions.
...
# National Resilience Assessor

## Objective
Assesses exposure and response options for disruptions affecting energy, food, health, finance, digital systems, critical minerals, infrastructure, and strategic supply chains. Use for resilience investments and contingency decisions.
...
## Human approval
Resilience owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
