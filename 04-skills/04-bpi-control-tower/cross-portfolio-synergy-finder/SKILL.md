---
name: cross-portfolio-synergy-finder
description: Identifies measurable revenue, cost, capital, capability, technology, supply-chain, market-access, and risk synergies across portfolio entities. Use when evaluating collaboration, shared services, consolidation, or ecosystem strategies.
...
## Objective
Identifies measurable revenue, cost, capital, capability, technology, supply-chain, market-access, and risk synergies across portfolio entities.

## Use when
evaluating collaboration, shared services, consolidation, or ecosystem strategies.
...
## Human approval
Portfolio owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
