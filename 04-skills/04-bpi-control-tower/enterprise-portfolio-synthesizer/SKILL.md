---
name: enterprise-portfolio-synthesizer
description: Produces a consolidated view of value, performance, risk, capital, impact, transformation, and concentration across the Danantara ecosystem. Use for enterprise reviews, supervisory reporting, and strategic capital allocation.
...
## Objective
Produces a consolidated view of value, performance, risk, capital, impact, transformation, and concentration across the Danantara ecosystem. Use for enterprise reviews, supervisory reporting, and strategic capital allocation.
...
## Human approval
Executive/supervisory owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
