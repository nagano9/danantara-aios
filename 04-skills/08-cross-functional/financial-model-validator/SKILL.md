...
description: Independently checks formulas, logic, inputs, circularity, units, scenarios, accounting consistency, outputs, controls, and documentation of financial models. Use before material reliance or approval.
...
## Objective
Independently checks formulas, logic, inputs, circularity, units, scenarios, accounting consistency, outputs, controls, and documentation of financial models. Use before material reliance or approval.
...
## Human approval
Independent model validation. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
