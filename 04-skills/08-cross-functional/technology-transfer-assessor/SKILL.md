---
name: technology-transfer-assessor
description: Tests whether partnerships deliver enduring local know-how, IP access, engineering capability, supplier development, training, standards, and operating independence. Use for foreign investment, procurement, licensing, and joint ventures.
...
## Objective
Tests whether partnerships deliver enduring local know-how, IP access, engineering capability, supplier development, training, standards, and operating independence. Use for foreign investment, procurement, licensing, and joint ventures.
...
## Human approval
Technology/industrial authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
