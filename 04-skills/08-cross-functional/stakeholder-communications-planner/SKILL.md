---
name: stakeholder-communications-planner
description: Maps stakeholders, interests, influence, concerns, disclosures, engagement sequence, messages, evidence, commitments, and escalation. Use for transactions, transformations, projects, incidents, partnerships, and public accountability.
...
## Objective
Maps stakeholders, interests, influence, concerns, disclosures, engagement sequence, messages, evidence, commitments, and escalation. Use for transactions, transformations, projects, incidents, partnerships, and public accountability.
...
## Human approval
Communications and decision owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
