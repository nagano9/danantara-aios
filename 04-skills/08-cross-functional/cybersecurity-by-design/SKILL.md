...
description: Defines security architecture, threat model, identity, access, encryption, monitoring, resilience, supply-chain security, incident response, and assurance from project inception. Use for digital platforms, AI, data, and critical infrastructure.
...
## Objective
Defines security architecture, threat model, identity, access, encryption, monitoring, resilience, supply-chain security, incident response, and assurance from project inception. Use for digital platforms, AI, data, and critical infrastructure.
...
## Human approval
CISO/security authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
