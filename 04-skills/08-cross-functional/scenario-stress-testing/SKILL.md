...
description: Designs coherent base, upside, downside, severe, and reverse-stress scenarios; quantifies impacts, breakpoints, management actions, and residual risk. Use for investments, portfolios, transformations, liquidity, and resilience decisions.
...
## Objective
Designs coherent base, upside, downside, severe, and reverse-stress scenarios; quantifies impacts, breakpoints, management actions, and residual risk. Use for investments, portfolios, transformations, liquidity, and resilience decisions.
...
## Human approval
Risk and decision owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
