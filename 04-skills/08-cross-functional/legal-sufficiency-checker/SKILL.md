---
name: legal-sufficiency-checker
description: Tests whether a proposal has adequate legal basis, authority, approvals, enforceability, documentation, rights, remedies, and compliance while distinguishing legal permissibility from strategic wisdom. Use before binding action.
...
## Objective
Tests whether a proposal has adequate legal basis, authority, approvals, enforceability, documentation, rights, remedies, and compliance while distinguishing legal permissibility from strategic wisdom. Use before binding action.
...
## Human approval
Legal authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
