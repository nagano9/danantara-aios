---
name: selective-import-substitution-test
description: Tests whether proposed import substitution is strategically critical, economically competitive, technologically feasible, time-bound, and superior to diversification or trade alternatives. Use before granting support or protection.
...
# Selective Import Substitution Test

## Objective
Tests whether proposed import substitution is strategically critical, economically competitive, technologically feasible, time-bound, and superior to diversification or trade alternatives. Use before granting support or protection.
...
## Human approval
Strategic and investment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
