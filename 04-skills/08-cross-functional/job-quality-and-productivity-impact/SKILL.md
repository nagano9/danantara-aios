---
name: job-quality-and-productivity-impact
description: Measures direct and indirect jobs, wages, skills, formalization, safety, inclusion, productivity, durability, and displacement effects. Use when employment is a stated investment, transformation, or development outcome.
...
# Job Quality And Productivity Impact

## Objective
Measures direct and indirect jobs, wages, skills, formalization, safety, inclusion, productivity, durability, and displacement effects.

## Use when
employment is a stated investment, transformation, or development outcome.
...
## Human approval
Impact owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
