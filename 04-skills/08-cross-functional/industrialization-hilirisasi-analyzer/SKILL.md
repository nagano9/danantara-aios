---
name: industrialization-hilirisasi-analyzer
description: Assesses value-chain upgrading, domestic value added, technology depth, productivity, export competitiveness, resource security, ecosystem readiness, and environmental constraints. Use for industrialization and downstream-investment decisions.
...
# Industrialization Hilirisasi Analyzer

## Objective
Assesses value-chain upgrading, domestic value added, technology depth, productivity, export competitiveness, resource security, ecosystem readiness, and environmental constraints. Use for industrialization and downstream-investment decisions.
...
## Human approval
Industrial strategy authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
