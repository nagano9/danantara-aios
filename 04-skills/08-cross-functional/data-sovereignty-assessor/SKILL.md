---
name: data-sovereignty-assessor
description: Determines which data, models, cloud layers, cryptographic control, operational access, and intellectual property require national or enterprise control. Use for digital infrastructure, AI, cloud, data-sharing, and foreign partnerships.
...
## Objective
Determines which data, models, cloud layers, cryptographic control, operational access, and intellectual property require national or enterprise control. Use for digital infrastructure, AI, cloud, data-sharing, and foreign partnerships.
...
## Human approval
Data, security, and strategic authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
