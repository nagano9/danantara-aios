...
description: Assesses model purpose, methodology, data, assumptions, limitations, calibration, sensitivity, governance, reproducibility, and misuse risk. Use for financial, economic, risk, forecasting, scoring, and AI models.
...
## Objective
Assesses model purpose, methodology, data, assumptions, limitations, calibration, sensitivity, governance, reproducibility, and misuse risk. Use for financial, economic, risk, forecasting, scoring, and AI models.
...
## Human approval
Independent model-risk authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
