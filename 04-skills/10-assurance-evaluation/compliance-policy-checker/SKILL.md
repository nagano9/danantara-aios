...
description: Checks outputs and proposed actions against applicable law, policy, delegations, standards, covenants, approvals, and control requirements; records exceptions and owners. Use before execution or formal submission.
...
## Objective
Checks outputs and proposed actions against applicable law, policy, delegations, standards, covenants, approvals, and control requirements; records exceptions and owners. Use before execution or formal submission.
...
## Human approval
Compliance/legal owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
