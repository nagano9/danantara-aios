---
name: confidentiality-leakage-check
description: Tests documents, prompts, outputs, tools, recipients, metadata, and attachments for unauthorized disclosure of strategic, market-sensitive, personal, contractual, or national-interest information. Use before sharing or publication.
...
## Objective
Tests documents, prompts, outputs, tools, recipients, metadata, and attachments for unauthorized disclosure of strategic, market-sensitive, personal, contractual, or national-interest information. Use before sharing or publication.
...
5. Rate severity, require remediation, assign owners, and determine whether the workflow must stop or escalate.
6. Issue an independent assurance result and preserve an auditable record.
...
## Output contract
Primary output: Independent assurance opinion; findings by severity; required remediation; stop/go/escalate recommendation; audit evidence.
...
## Human approval
Information-security owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
