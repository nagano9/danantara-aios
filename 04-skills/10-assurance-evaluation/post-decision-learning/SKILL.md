...
## Objective
Compares expected and actual outcomes, identifies thesis or execution errors, captures lessons, updates controls, and assigns corrective actions. Use after milestones, exits, incidents, restructurings, and material decisions.
...
## Human approval
Decision owner and assurance. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
