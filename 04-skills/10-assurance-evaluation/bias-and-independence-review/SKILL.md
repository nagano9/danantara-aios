---
name: bias-and-independence-review
description: Tests anchoring, confirmation, political, sponsor, sunk-cost, optimism, groupthink, selection, and model biases; checks reviewer independence and dissent quality. Use before material decisions and exception approvals.
...
## Objective
Tests anchoring, confirmation, political, sponsor, sunk-cost, optimism, groupthink, selection, and model biases; checks reviewer independence and dissent quality. Use before material decisions and exception approvals.
...
## Human approval
Independent review owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
