---
name: evidence-citation-auditor
description: Verifies that material claims are supported by authoritative, current, traceable sources and that quotations, calculations, and interpretations accurately represent the evidence. Use before formal decision or publication.
...
## Objective
Verifies that material claims are supported by authoritative, current, traceable sources and that quotations, calculations, and interpretations accurately represent the evidence. Use before formal decision or publication.
...
## Human approval
Independent reviewer. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
