---
name: skill-evaluation-runner
description: Runs schema, trigger, non-trigger, functional, golden-case, adversarial, safety, governance, and regression evaluations for Claude Skills. Use before release, after changes, and on a defined monitoring cycle.
...
## Objective
Runs schema, trigger, non-trigger, functional, golden-case, adversarial, safety, governance, and regression evaluations for Claude Skills. Use before release, after changes, and on a defined monitoring cycle.
...
## Human approval
AI assurance owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
