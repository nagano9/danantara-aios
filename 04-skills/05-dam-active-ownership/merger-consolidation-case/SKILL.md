---
name: merger-consolidation-case
description: Builds the economic, strategic, governance, competition, operational, people, technology, and execution case for merger or consolidation. Use only when measurable parenting and synergy advantages exceed integration costs and risks.
...
## Objective
Builds the economic, strategic, governance, competition, operational, people, technology, and execution case for merger or consolidation. Use only when measurable parenting and synergy advantages exceed integration costs and risks.
...
## Human approval
Competent corporate and regulatory authorities. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
