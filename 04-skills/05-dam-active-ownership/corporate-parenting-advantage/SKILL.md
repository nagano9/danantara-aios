---
name: corporate-parenting-advantage
description: Tests whether Danantara can create more value through governance, capital, talent, market access, technology, risk management, or synergy than an entity could create independently. Use before ownership interventions or retention decisions.
...
## Objective
Tests whether Danantara can create more value through governance, capital, talent, market access, technology, risk management, or synergy than an entity could create independently. Use before ownership interventions or retention decisions.
...
## Human approval
DAM portfolio authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
