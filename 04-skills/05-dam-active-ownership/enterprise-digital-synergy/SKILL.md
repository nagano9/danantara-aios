---
name: enterprise-digital-synergy
description: Identifies duplicated applications, data, vendors, capabilities, and platforms; defines what should be shared, standardized, interoperable, federated, or retired. Use for cross-BUMN digital strategy and investment review.
...
## Objective
Identifies duplicated applications, data, vendors, capabilities, and platforms; defines what should be shared, standardized, interoperable, federated, or retired. Use for cross-BUMN digital strategy and investment review.
...
## Human approval
Enterprise architecture authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
