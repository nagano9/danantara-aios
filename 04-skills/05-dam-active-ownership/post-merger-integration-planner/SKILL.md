...
description: Plans value capture, Day-1 continuity, governance, organization, talent, culture, processes, systems, data, controls, brand, and stakeholder integration after corporate consolidation. Use before closing and through stabilization.
...
## Objective
Plans value capture, Day-1 continuity, governance, organization, talent, culture, processes, systems, data, controls, brand, and stakeholder integration after corporate consolidation. Use before closing and through stabilization.
...
## Human approval
Integration sponsor. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
