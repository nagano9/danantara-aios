---
name: portfolio-rationalization-analyzer
description: Evaluates whether entities, subsidiaries, assets, and business lines should remain standalone, merge, consolidate, divest, liquidate, or form partnerships. Use when structure no longer matches economic or strategic logic.
...
## Objective
Evaluates whether entities, subsidiaries, assets, and business lines should remain standalone, merge, consolidate, divest, liquidate, or form partnerships.

## Use when
structure no longer matches economic or strategic logic.
...
## Human approval
DAM and competent corporate bodies. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
