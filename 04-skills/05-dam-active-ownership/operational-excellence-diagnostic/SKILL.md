---
name: operational-excellence-diagnostic
description: Diagnoses reliability, productivity, cost, quality, service, asset utilization, process waste, maintenance, supply chain, and execution discipline against relevant benchmarks. Use for performance improvement and turnaround design.
...
## Objective
Diagnoses reliability, productivity, cost, quality, service, asset utilization, process waste, maintenance, supply chain, and execution discipline against relevant benchmarks. Use for performance improvement and turnaround design.
...
## Human approval
Portfolio company and DAM owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
