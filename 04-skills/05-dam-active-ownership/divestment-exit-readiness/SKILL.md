---
name: divestment-exit-readiness
description: Assesses strategic rationale, value, marketability, legal readiness, stakeholder impact, separation complexity, data-room readiness, and timing for divestment or exit. Use for non-core assets and rational ownership decisions.
...
## Objective
Assesses strategic rationale, value, marketability, legal readiness, stakeholder impact, separation complexity, data-room readiness, and timing for divestment or exit. Use for non-core assets and rational ownership decisions.
...
## Human approval
Authorized divestment authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
