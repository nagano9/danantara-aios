---
name: turnaround-triage
description: Distinguishes temporary liquidity stress, operational underperformance, balance-sheet distress, governance failure, and structurally broken business models. Use at the first sign of material deterioration or support requests.
...
## Objective
Distinguishes temporary liquidity stress, operational underperformance, balance-sheet distress, governance failure, and structurally broken business models. Use at the first sign of material deterioration or support requests.
...
## Human approval
DAM turnaround authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
