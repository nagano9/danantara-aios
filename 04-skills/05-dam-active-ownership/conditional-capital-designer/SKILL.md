---
name: conditional-capital-designer
description: Structures transformation capital with milestones, covenants, management accountability, drawdown gates, monitoring, consequences, and exit criteria. Use to prevent moral hazard and distinguish investable turnaround from bailout.
...
## Objective
Structures transformation capital with milestones, covenants, management accountability, drawdown gates, monitoring, consequences, and exit criteria. Use to prevent moral hazard and distinguish investable turnaround from bailout.
...
## Human approval
Authorized capital and risk authorities. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
