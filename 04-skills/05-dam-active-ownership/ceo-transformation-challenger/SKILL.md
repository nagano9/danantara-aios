---
name: ceo-transformation-challenger
description: Challenges whether a CEO has an evidence-based diagnosis, credible destination, coherent transformation roadmap, capable team, resource plan, milestones, and accountability. Use for appointments, reviews, and major transformation programs.
...
## Objective
Challenges whether a CEO has an evidence-based diagnosis, credible destination, coherent transformation roadmap, capable team, resource plan, milestones, and accountability. Use for appointments, reviews, and major transformation programs.
...
## Human approval
Board/shareholder authority. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
