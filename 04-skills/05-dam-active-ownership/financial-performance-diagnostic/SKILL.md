...
description: Analyzes earnings quality, cash conversion, balance sheet, liquidity, leverage, returns, capital intensity, dividend capacity, and value leakage. Use for portfolio reviews, interventions, restructuring, and capital decisions.
...
## Objective
Analyzes earnings quality, cash conversion, balance sheet, liquidity, leverage, returns, capital intensity, dividend capacity, and value leakage. Use for portfolio reviews, interventions, restructuring, and capital decisions.
...
## Human approval
Finance and portfolio owner. The skill may analyze, challenge, draft, calculate, and recommend. It may not execute, bind, disclose, waive, appoint, dismiss, allocate capital, or record final approval unless a separate authorized system provides verified evidence of that human action.
