...
- a workflow-state agent that preserves the current loop state for resumption
...
tracks workflow state, runs the repo checks, and returns a consolidated audit
decision.
